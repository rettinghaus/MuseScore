...
private:
    ...
    MEIPosition findStart(const libmei::Element& meiElement, engraving::Measure* measure);
    MEIPosition findEnd(pugi::xml_node controlNode, engraving::Spanner* spanner);
