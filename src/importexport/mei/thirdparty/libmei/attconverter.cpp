...
std::string AttConverterBase::MeiVersionMeiversionToStr(meiVersion_MEIVERSION data) const
{
    std::string value;
    switch (data) {
        case meiVersion_MEIVERSION_5_1_dev: value = "5.1-dev"; break;
        case meiVersion_MEIVERSION_5_1_devplusbasic: value = "5.1-dev+basic"; break;
        default:
...
{
    if (value == "5.1-dev") return meiVersion_MEIVERSION_5_1_dev;
    if (value == "5.1-dev+basic") return meiVersion_MEIVERSION_5_1_devplusbasic;
    if (logWarning && !value.empty())
